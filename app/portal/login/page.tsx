  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] px-4 relative overflow-hidden">
      <div
        ...
        style={{ backgroundImage: 'radial-gradient(circle, rgba(42,138,173,0.35) 1px, transparent 1px)', backgroundSize: '28px 28px' }}
      />
      <div className="relative bg-[#141414] border border-white/[0.08] rounded-2xl shadow-2xl p-8 max-w-sm w-full">
        <img src="/logo.png" alt="MK Finance" className="h-10 w-auto mb-8" />
        ...
        {step === 'mobile' && (
          <form onSubmit={handleRequestOtp}>
            ...
            <input
              className="w-full bg-[#0a0a0a] border border-white/10 text-white placeholder:text-white/25 rounded-lg px-3.5 py-2.5 mb-5 text-sm focus:outline-none focus:ring-2 focus:ring-[#2a8aad]/40"
              value={mobile}
            ...
            <button disabled={loading} className="w-full bg-[#e63030] hover:bg-[#b01c1c] text-white rounded-lg py-2.5 font-semibold text-sm disabled:opacity-60 transition-colors">
        ...
        {step === 'otp' && (
          <form onSubmit={handleVerify}>
            ...
            <button disabled={loading} className="w-full bg-[#e63030] hover:bg-[#b01c1c] text-white rounded-lg py-2.5 font-semibold text-sm disabled:opacity-60 transition-colors mb-3">
